// ============================================================================
// gandiva_debug.sv — RISC-V External Debug (Debug Spec 0.13.2) for Gandiva.
//
// Provides what PicoRV32 (only a partial/custom debug port) and a base SERV do
// not ship by default: a *standard* Debug Transport Module (JTAG DTM) + Debug
// Module (DM) that OpenOCD + GDB drive out of the box.
//
...
module gandiva_debug #(
  parameter logic [31:0] IDCODE = 32'h4741_4E44   // "GAND", bit0=1 per JTAG
)(
  input  wire        clk,
  input  wire        rst,
  ...
  // ---- hart control (to/from gandiva_core) ---------------------------------
